...
kubectl apply -f food-service/deployment.yaml -n $NAMESPACE
kubectl apply -f food-service/service-svc.yaml -n $NAMESPACE
kubectl apply -f food-service/hpa.yaml -n $NAMESPACE
kubectl apply -f food-service/pdb.yaml -n $NAMESPACE
kubectl apply -f food-service/network-policy.yaml -n $NAMESPACE